...
seedword_dict_1d <- dictionary(list(
  positive = c("islamaphobia", "love", "together", "racist", "#refugeeswelcome", "tories", "welcome",
               "empathy", "positive", "benefit", "amazing", "vulnerable"),
  negative = c("disgraceful", "#buildthewall","deport", "control", "#travelban", "blood", "thug", "disgusting",
               "illegals", "evil", "problem", "mass", "dumped", "destroyed", "vet", "#closetheborders", "murders")
  ))


seedword_dict_1e <- dictionary(list(
  positive = c("islamaphobia", "love", "together", "racist", "#refugeeswelcome", "tories", "welcome",
               "empathy", "positive", "benefit", "amazing", "vulnerable"),
  negative = c("disgraceful", "#buildthewall","deport", "#travelban", "blood", "thug", 
               "bad", "nasty", "wrong", "illegals", "illegal", "horrible", "evil", "problem", "mass", "dumped", "destroyed",
...
```{r cache=TRUE}
lss_alll_output <- lss_function(corpus_alll, seedword_dict_1e, k_val = 300)
...
print(textplot_terms(lss_mod_alll, seedword_dict_1e))
